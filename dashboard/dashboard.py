...
#membuka dataframe
year_df = pd.read_csv("https://github.com/agna2103/l_analisis_data/blob/main/dashboard/years.csv")
month_df = pd.read_csv("https://github.com/agna2103/l_analisis_data/blob/main/dashboard/month.csv")
